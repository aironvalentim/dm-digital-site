...
export default function Hero() {
  ...
  return (
    <section id="inicio" className="relative min-h-screen overflow-hidden">
      <div className="absolute inset-x-0 top-24 bottom-0 bg-cover" style={{ backgroundImage: `url(${bg})`, backgroundPosition: "52% 20%" }} />
      <div className="absolute inset-x-0 top-24 bottom-0" style={{ background: "linear-gradient(90deg, rgba(0,0,0,0.8) 0%, rgba(0,0,0,0.6) 50%, rgba(0,0,0,0.4) 100%)" }} />

      <div className="relative z-10 min-h-screen flex items-center justify-center pt-24 px-6">
